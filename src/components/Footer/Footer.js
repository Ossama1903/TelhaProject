      ...
      <div className="px-4 py-16 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            ...
            <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
              <form className="w-full text-white">
                ...
                <div className="p-2 border rounded-full sm:flex sm:items-center border-white">
                  <input
                    className="w-full rounded-full h-12 p-3 mr-2 text-sm font-medium tracking-widest placeholder-gray-100 uppercase bg-transparent border-none"
                    type="email"
                    id="email"
                    placeholder="Enter your email"
                  />
                  <Button text='SignUp' width={10} height={4} />
                </div>
              </form>
            </div>
            <div className="pt-6 border-t col-span-2 sm:col-span-1 border-white">
              <p className="font-bold text-white"> Services </p>
              <nav className="flex flex-col mt-6 text-sm text-gray-100 space-y-4">
        ...
        <div className="pt-8 mt-12 border-t border-white">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <nav className="flex justify-center text-xs text-gray-100 space-x-4 lg:justify-end">
